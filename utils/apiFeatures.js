...
class APIFeatures {
    ...
    paginate() {
      ...
      const limit = this.queryString.limit * 1 || 10; // converts string to number and set default value of limit to 10. Example: we have more then 1 million documents in our collection. We just wanna show the user 30 
